...
function L0(t) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$ethereum$2d$provider$2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(e)) throw new Error("Invalid chains");
    const c = {
        chains: e,
        methods: n || wo,
        events: o || mo,
...
class ca {
    ...
    async connect(e) {
        ...
        try {
            ...
            if (!o) return;
            const s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$ethereum$2d$provider$2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccountsFromNamespaces"])(o.namespaces, [
                this.namespace
            ]);
    ...
    loadConnectOpts(e) {
        ...
        r && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$ethereum$2d$provider$2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(r) && (this.rpc.chains = r.map((o)=>this.formatChainId(o)), r.forEach((o)=>{
            this.rpc.rpcMap[o] = i?.[o] || this.getRpcUrl(o);
        })), n && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$ethereum$2d$provider$2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(n) && (this.rpc.optionalChains = [], this.rpc.optionalChains = n?.map((o)=>this.formatChainId(o)), n.forEach((o)=>{
            this.rpc.rpcMap[o] = i?.[o] || this.getRpcUrl(o);
        }));
    }
    getRpcUrl(e, r) {
...
//# sourceMappingURL=node_modules_%40walletconnect_ethereum-provider_dist_index_es_9fd468fc.js.map