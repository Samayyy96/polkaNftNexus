...
contract NFTMarketplace is ERC721URIStorage {
    ...
    (bool sentOwner, ) = payable(owner).call{value: mintingPrice}("");
    require(sentOwner, "Failed to send minting fee to owner");

    // Pay seller
    (bool sentSeller, ) = payable(seller).call{value: msg.value - mintingPrice}("");
