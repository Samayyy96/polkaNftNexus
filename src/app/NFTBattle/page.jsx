      ...
      <div className="battle-page">
        ...
        <div className="battle-container">
            ...
            <section className="battle-section">
              ...
              <div className="input-group">
                 <label htmlFor="stakeAmount">Stake Amount (PAS)</label>
                <input
                  id="stakeAmount"
                  type="number"
                ...
                <section className="battle-section rules-section">
                    ...
                    <div className="rules-content">
                        ...
                        <ul>
                            ...
                            <li>Specify the amount of <strong>PAS to stake</strong> for this battle.</li>
                            ...
                            <li>The winner receives a portion of the total staked PAS pot.</li>
